const PORTFOLIO_DATA = {
    ...
    i18n: {
        ...
        analytics: {
            ...
            liveLabel: { en: 'Live GitHub Snapshot', vi: 'Ảnh chụp GitHub thời gian thực' },
            ...
            topRepos: { en: 'Most Active Repositories', vi: 'Repository hoạt động mạnh' },
            ...
            kpiFresh30: { en: 'Fresh <= 30 Days', vi: 'Mới <= 30 ngày' },
            ...
            tableRepo: { en: 'Repository', vi: 'Repository' },
            tableLanguage: { en: 'Language', vi: 'Ngôn ngữ' },
            tableUpdated: { en: 'Last Update', vi: 'Cập nhật cuối' },
